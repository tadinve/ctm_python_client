...
class UpgradeRequest(object):
    ...
    def __init__(self, ctm=None, agent=None, type=None, version=None, activity_name=None, install_user=None, notify_address=None, description=None, _configuration=None):  # noqa: E501
