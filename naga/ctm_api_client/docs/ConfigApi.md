...
server = 'server_example' # str | The Server.
agent = 'agent_example' # str | The Agent.
body = ctm_api_client.PingAgentParams() # PingAgentParams |  (optional)
...
body = ctm_api_client.OptionalValue() # OptionalValue | The new parameter value. (optional)
...
new_value = ctm_api_client.Value() # Value | Param new value
...
# **test_run_as_user**
> SuccessData test_run_as_user(server, agent, user, run_as_user_details_data=run_as_user_details_data)
...
agent = 'agent_example' # str | The Agent
user = 'user_example' # str | The user name
run_as_user_details_data = ctm_api_client.RunAsUserDetailsData() # RunAsUserDetailsData | Run as user details data (optional)

try:
    # Test existed Run-as user
    api_response = api_instance.test_run_as_user(server, agent, user, run_as_user_details_data=run_as_user_details_data)
    pprint(api_response)
except ApiException as e:
...
# **update_archive_rule**
> SuccessData update_archive_rule(rule_name, archive_rule)
...
archive_rule = ctm_api_client.ArchiveRule() # ArchiveRule | Edit Workload Archiving rule details

try:
    # Edit Workload Archiving rule
    api_response = api_instance.update_archive_rule(rule_name, archive_rule)
    pprint(api_response)
except ApiException as e:
 ...
 **archive_rule** | [**ArchiveRule**](ArchiveRule.md)| Edit Workload Archiving rule details | 
...
> SuccessData update_external_user(username, external_user_data)
...
try:
    # Update an external user
    api_response = api_instance.update_external_user(username, external_user_data)
    pprint(api_response)
except ApiException as e:
...
# **update_fts_settings**
> SuccessData update_fts_settings(server, agent, fts_settings_data)
...
server = 'server_example' # str | The Server
agent = 'agent_example' # str | The Agent
fts_settings_data = ctm_api_client.FtsSettingsData() # FtsSettingsData | File Transfer Server (FTS) configuration data

try:
    # Update File Transfer Server (FTS) configuration data.
    api_response = api_instance.update_fts_settings(server, agent, fts_settings_data)
    pprint(api_response)
except ApiException as e:
 ...
 **server** | **str**| The Server | 
 **agent** | **str**| The Agent | 
 **fts_settings_data** | [**FtsSettingsData**](FtsSettingsData.md)| File Transfer Server (FTS) configuration data | 
...
> SuccessData update_hosts_in_hostgroup(server, hostgroup, host_group_member_params_list)
...
server = 'server_example' # str | The Server the agent is connected to.
hostgroup = 'hostgroup_example' # str | The hostgroup name
host_group_member_params_list = ctm_api_client.HostgroupProperties() # HostgroupProperties | Agent list to update in a hostgroup

try:
    # update agents in hostgroup.
    api_response = api_instance.update_hosts_in_hostgroup(server, hostgroup, host_group_member_params_list)
    pprint(api_response)
except ApiException as e:
 ...
 **server** | **str**| The Server the agent is connected to. | 
 **hostgroup** | **str**| The hostgroup name | 
 **host_group_member_params_list** | [**HostgroupProperties**](HostgroupProperties.md)| Agent list to update in a hostgroup | 
...
> SuccessData update_mft_configuration(server, agent, mft_configuration_data)
...
server = 'server_example' # str | The Server
agent = 'agent_example' # str | The Agent
mft_configuration_data = ctm_api_client.MftConfigurationData() # MftConfigurationData | MFT Configuration Data

try:
    # Update MFT Configuration
    api_response = api_instance.update_mft_configuration(server, agent, mft_configuration_data)
    pprint(api_response)
except ApiException as e:
 ...
 **server** | **str**| The Server | 
 **agent** | **str**| The Agent | 
 **mft_configuration_data** | [**MftConfigurationData**](MftConfigurationData.md)| MFT Configuration Data | 
...
# **update_mft_folder**
> SuccessData update_mft_folder(folder_name, folder_properties_data)
...
try:
    # Update an existing virtual folder in MFT.
    api_response = api_instance.update_mft_folder(folder_name, folder_properties_data)
    pprint(api_response)
except ApiException as e:
...
> SuccessData update_mft_user_group(name, user_group_details_data)
...
api_instance = ctm_api_client.ConfigApi(ctm_api_client.ApiClient(configuration))
name = 'name_example' # str | User group name
user_group_details_data = ctm_api_client.UserGroupDetailsData() # UserGroupDetailsData | User group details

try:
    # Update user group.
    api_response = api_instance.update_mft_user_group(name, user_group_details_data)
    pprint(api_response)
except ApiException as e:
...
------------- | ------------- | ------------- | -------------
 **name** | **str**| User group name | 
 **user_group_details_data** | [**UserGroupDetailsData**](UserGroupDetailsData.md)| User group details | 
...
# **update_pgp_template**
> SuccessData update_pgp_template(server, agent, template_name, pgp_template_data)
...
try:
    # Update PGP Template
    api_response = api_instance.update_pgp_template(server, agent, template_name, pgp_template_data)
    pprint(api_response)
except ApiException as e:
...
# **update_run_as_user**
> SuccessData update_run_as_user(server, agent, user, run_as_user_details_data)
...
agent = 'agent_example' # str | The Agent
user = 'user_example' # str | The user name
run_as_user_details_data = ctm_api_client.RunAsUserDetailsData() # RunAsUserDetailsData | Run as user details data

try:
    # Update Run-as user
    api_response = api_instance.update_run_as_user(server, agent, user, run_as_user_details_data)
    pprint(api_response)
except ApiException as e:
...
api_instance = ctm_api_client.ConfigApi(ctm_api_client.ApiClient(configuration))
name = 'name_example' # str | The name of the secret to update
value = ctm_api_client.SecretValue() # SecretValue | The new value for the secret (optional)
...
# **update_zos_template**
> SuccessData update_zos_template(server, agent, template_name, zos_template_data)
...
try:
    # Update z/OS Template
    api_response = api_instance.update_zos_template(server, agent, template_name, zos_template_data)
    pprint(api_response)
except ApiException as e:
