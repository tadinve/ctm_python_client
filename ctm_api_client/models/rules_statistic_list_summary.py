...
class RulesStatisticListSummary(object):
    ...
    """
    swagger_types = {"rules_statistic_list": "RulesStatisticList", "summary": "Summary"}

    attribute_map = {"rules_statistic_list": "rulesStatisticList", "summary": "summary"}

    def __init__(
        self, rules_statistic_list=None, summary=None, _configuration=None
    ):  # noqa: E501
