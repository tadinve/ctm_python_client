...
class PoolVariablesName(object):
    ...
    """
    swagger_types = {"pool_name": "str", "variable_name": "list[str]"}

    attribute_map = {"pool_name": "pool_name", "variable_name": "variable_name"}

    def __init__(
        self, pool_name=None, variable_name=None, _configuration=None
    ):  # noqa: E501
