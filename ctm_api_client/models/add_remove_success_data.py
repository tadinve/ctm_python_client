...
class AddRemoveSuccessData(object):
    ...
    """
    swagger_types = {"message": "str", "current_items": "list[str]"}

    attribute_map = {"message": "message", "current_items": "currentItems"}

    def __init__(
        self, message=None, current_items=None, _configuration=None
    ):  # noqa: E501
