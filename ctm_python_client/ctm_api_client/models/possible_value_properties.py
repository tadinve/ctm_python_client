...
class PossibleValueProperties(object):
    ...
    """
    swagger_types = {"label": "str", "label_id": "str", "value": "str"}

    attribute_map = {"label": "label", "label_id": "labelID", "value": "value"}

    def __init__(
        self, label=None, label_id=None, value=None, _configuration=None
    ):  # noqa: E501
