...
class AddServerParams(object):
    ...
    """
    swagger_types = {"host": "str", "ctm": "str", "id": "str", "port": "int"}

    attribute_map = {"host": "host", "ctm": "ctm", "id": "id", "port": "port"}

    def __init__(
        self, host=None, ctm=None, id=None, port=None, _configuration=None
    ):  # noqa: E501
