...
class FtsUserHomeDirectoryData(object):
    ...
    """
    swagger_types = {"user_name": "str", "home_directory": "str"}

    attribute_map = {"user_name": "userName", "home_directory": "homeDirectory"}

    def __init__(
        self, user_name=None, home_directory=None, _configuration=None
    ):  # noqa: E501
