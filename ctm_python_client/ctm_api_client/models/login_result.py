...
class LoginResult(object):
    ...
    """
    swagger_types = {"username": "str", "token": "str", "version": "str"}

    attribute_map = {"username": "username", "token": "token", "version": "version"}

    def __init__(
        self, username=None, token=None, version=None, _configuration=None
    ):  # noqa: E501
