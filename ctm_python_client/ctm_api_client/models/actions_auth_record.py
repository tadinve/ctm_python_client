...
class ActionsAuthRecord(object):
    ...
    def __init__(self, destination=None, action=None, category=None, auth_level=None, action_type=None, additional_info=None, category2=None, policy=None, auth_attr=None, _configuration=None):  # noqa: E501
    ...
    def destination(self, destination):
        ...
        if (self._configuration.client_side_validation and
                destination not in allowed_values):
            raise ValueError(
