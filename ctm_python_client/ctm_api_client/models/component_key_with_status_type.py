...
class ComponentKeyWithStatusType(object):
    ...
    """
    swagger_types = {"component_key": "ComponentMftKeyType", "status": "int"}

    attribute_map = {"component_key": "componentKey", "status": "status"}

    def __init__(
        self, component_key=None, status=None, _configuration=None
    ):  # noqa: E501
