...
class PoolVariablesErrorInfo(object):
    ...
    """
    swagger_types = {"ctmvar_error_info": "list[CtmvarErrorInfo]", "pool_name": "str"}

    attribute_map = {"ctmvar_error_info": "ctmvar_error_info", "pool_name": "pool_name"}

    def __init__(
        self, ctmvar_error_info=None, pool_name=None, _configuration=None
    ):  # noqa: E501
