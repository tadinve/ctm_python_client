...
Naga is commonly used to process data, but has the opinion that tasks should ideally be idempotent 

Naga is not a streaming solution, but it is often used to process real-time data, pulling data off streams in batches.
...
- **Elegant**:  Naga pipelines are lean and explicit. Parameterizing your scripts is built into the core of Naga using the powerful **Jinja** templating engine.
...
| Docker               | 9.6, 10, 11, 12, 13       | 9.6, 10, 11, 12, 13      |
