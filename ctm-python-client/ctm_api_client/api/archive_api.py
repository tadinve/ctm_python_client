...
class ArchiveApi(object):
    ...
    def get_archive_job_log_with_http_info(self, job_id, run_no, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('run_no' not in params or
                                                       params['run_no'] is None):  # noqa: E501
    ...
    def search_jobs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] > 1000):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `search_jobs`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `search_jobs`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
