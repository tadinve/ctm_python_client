...
class CtmvarSetResultItem(object):
    ...
    """
    swagger_types = {
        'set_pool_variables_error_info': 'PoolVariablesErrorInfo'
    }

    attribute_map = {
        'set_pool_variables_error_info': 'set_pool_variables_error_info'
    }

    def __init__(self, set_pool_variables_error_info=None, _configuration=None):  # noqa: E501
