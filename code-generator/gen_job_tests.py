...
def json_to_job(j):
    ...
    folder_name = "../ctm_python_client/new" + "/".join(folder_name).lower() 
    ...
    with open(file_name,"w") as f:
        ...
        f.write("from ctm_python_client.core import bmc_control_m as ctm_python_client\n")
        f.write("from ctm_python_client." + job_type.replace(":",".").lower().replace("job","jobs") + 
                " import " + job_name + "\n")
        f.write("\n")
        ...
        f.write("\t\tflow = ctm_python_client.CmJobFlow(application='',sub_application='')\n")
